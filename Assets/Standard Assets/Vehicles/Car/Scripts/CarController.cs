...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        public const string DirFrames = "Camera-Frames";
		...
		public IEnumerator WriteSamplesToDisk()
		{
			...
			if (carSamples.Count > 0) {
				...
				string centerPath = WriteImage (CenterCamera, "Center_Frame", sample.timeStamp);
				string leftPath = WriteImage (LeftCamera, "Left_Frame", sample.timeStamp);
				string rightPath = WriteImage (RightCamera, "Right_Frame", sample.timeStamp);
				//string cameraPath = WriteImage (CenterCamera, "Camera_Frame", sample.timeStamp);
